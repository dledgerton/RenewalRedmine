...
workbook = xlsxwriter.Workbook('c:/users/a62478/Desktop/RenewalRedmineData.xlsx')
...
AllRedmineProjects = redmine.project.all()


for project in AllRedmineProjects:

    try:
        selected_project = redmine.project.get(project.identifier)
    except:
